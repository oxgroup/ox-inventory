...
import { Plus, List, AlertTriangle, RefreshCw, Wifi, WifiOff, Home } from "lucide-react"
...
import { authService, type Usuario, type AuthState, AuthError } from "../shared/lib/auth"
import { LoadingState, connectivity } from "../shared/lib/utils"
  ...
  const LoadingScreen = () => (
    <div className="min-h-screen bg-gradient-to-br from-[#A9C4E5] to-[#F4DDAE] flex items-center justify-center">
      <div className="text-center space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-[#5F6B6D] font-medium">Carregando Inventário...</p>
        ...
        return (
          <div className="min-h-screen bg-gradient-to-br from-[#A9C4E5] to-[#F4DDAE] p-4">
            <div className="max-w-md mx-auto space-y-6">
              {/* Header com info do usuário e link para dashboard */}
              <div className="flex items-center justify-between mb-4">
                <Link href="/">
                  <Button variant="ghost" className="text-[#000000] hover:bg-[#fabd07]/10">
                    <Home className="w-4 h-4 mr-2" />
                    Dashboard
                  </Button>
                </Link>
              ...
              <div className="text-center pt-4">
                <p className="text-[#5F6B6D] text-sm">Módulo Inventário - OX Management System</p>
              </div>
            </div>
          </div>
        )
